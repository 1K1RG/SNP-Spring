...
function VarietyListForm({varietySets, varietyListsNames, fetchLists}) {
  ...
  const validate = () => {
    ...
    if(formData.name.trim() && varietyListsNames.includes(formData.name.trim())){
...
export default VarietyListForm;
